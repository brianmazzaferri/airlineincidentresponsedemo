...
const app = new App({
  ...
  scopes: ['channels:join','channels:manage','channels:read','chat:write','chat:write.public','groups:write','links:write','commands', 'pins:write','workflow.steps:execute'], //add scopes here
  installationStore: {
